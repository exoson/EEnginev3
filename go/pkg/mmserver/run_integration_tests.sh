...
# TODO() Do this in go
psql -U postgres -h localhost -d db_mmserver -c "insert into tb_server (id, ip, secret) values ('f1638488-1de7-457d-91d2-64f06c8edd1f', 'exxxooo.servegame.com', 'servusala');"
